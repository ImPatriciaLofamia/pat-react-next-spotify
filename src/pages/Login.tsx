...
export const Login = () => {
  return (
    <div className="flex-1 justify-center w-screen">
      <div>
        <div className="text-center text-3xl font-bold m-2 pt-5 pb-5 border-b-2">
          <Labels
            icon={
      ...
      <div className="flex-1 justify-center">
        <div className="">
          <div className="pb-2 pt-5 text-sm font-sans font-semibold flex justify-center">
            <Text paragraph="To continue, log in to Spotify." />
          </div>
